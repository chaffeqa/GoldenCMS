class Admin::AdministratorsRegistrationsController < ApplicationController
  # Skip these filters to prevent site initialization flow errors
  skip_filter :initialize_requested_site, :check_administrative_account_count
  ...
  def create
    ...
    if resource.save
      if resource.active_for_authentication?
        ...
        sign_in(resource_name, resource) unless signed_in_resource
